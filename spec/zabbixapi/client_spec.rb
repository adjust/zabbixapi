...
describe 'ZabbixApi::Client' do
  ...
  describe '.id' do
    ...
    before do
      allow_any_instance_of(ZabbixApi::Client).to receive(:api_version).and_return('6.4')
  ...
  describe '.api_version' do
    ...
    before do
      allow_any_instance_of(ZabbixApi::Client).to receive(:auth).and_return('6.4')
    ...
    context 'when api_version is already set' do
      before do
        client_mock.instance_variable_set(:@api_version, '6.4')
      end
